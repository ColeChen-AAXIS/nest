...
export class Config {
    ...
    'jhipster.mail.from' = 'Ncl@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'Ncl API';
    'jhipster.swagger.description' = 'Ncl API documentation';
    ...
    'eureka.instance.appname' = 'Ncl';
    'eureka.instance.instanceId' = 'Ncl:${random.value}';
