...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('nclApp.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/nclApp.category.delete.question/);
