...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('nclApp.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/nclApp.tag.delete.question/);
